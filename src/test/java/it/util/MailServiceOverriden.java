 ...
 */
public class MailServiceOverriden extends MailService
{
    ...
    public MailServiceOverriden(FuncTestLogger log)
    {
        super(log);
        this.log = log;
    }
    ...
    private GreenMail tryStartingGreenMail(ServerSetup[] serverSetups)
    {
        ...
        // 2. For each mail server added, check if any have failed to start
    ...
    public void sendAttachmentMessage(String to, String from, String subject, String body, byte[] attachment, String contentType, String attachmentFilename, String description ) throws IOException, MessagingException {
        sendAttachmentEmail(to, from, subject, body, attachment, contentType, attachmentFilename, description,greenMail.getSmtp().getServerSetup());
        try
        {
            greenMail.waitForIncomingEmail(1);
        }
    ...
    private static void sendMultipart(String to, String from, String subject, String msg, final ServerSetup setup) {
        try {
            Session session = getSession(setup);
    ...
    private static void sendAttachmentEmail(String to, String from, String subject, String msg, final byte[] attachment, final String contentType, final String filename, final String description, final ServerSetup setup) throws MessagingException, IOException {
        Session session = getSession(setup);
